...
if s:configuration.disable_italic_comment
  " call s:HL('Comment', s:palette.bg0, s:palette.bg5)
  " call s:HL('SpecialComment', s:palette.bg0, s:palette.bg5)
  highlight SpecialComment ctermfg=243
  highlight Comment ctermfg=243
  call s:HL('Todo', s:palette.purple, s:palette.none)
else
  " call s:HL('Comment', s:palette.bg0, s:palette.bg5, 'italic')
  " call s:HL('SpecialComment', s:palette.bg0, s:palette.bg5, 'italic')

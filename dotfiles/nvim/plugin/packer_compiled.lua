...
_G.packer_plugins = {
  ...
  nvim_rocks = {
    loaded = true,
    path = "/Users/fujimotogen/.local/share/nvim/site/pack/packer/start/nvim_rocks"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'emmet-vim', 'vim-latex', 'previm', 'goyo.vim', 'vimtex', 'tagbar-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
vim.cmd [[au FileType md ++once lua require("packer.load")({'emmet-vim', 'previm', 'goyo.vim', 'vimtex', 'tagbar-markdown'}, { ft = "md" }, _G.packer_plugins)]]
